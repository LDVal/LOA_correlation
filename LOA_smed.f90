...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     ! we choose the configuration that maximazes k_i1*k_j1+k_i2*k_j2 with probability "p"
     ...
     !then we will check if reconnecting "v1" to "v3" and "v2" to "v3" increases the Pearson Corr. Coef. when election=1 (assortative case)
